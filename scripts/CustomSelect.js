export class CustomSelect {
  ...
  constructor(target, params) {
    ...
    this._elToggle = this._elRoot.querySelector(
      CustomSelect.SELECTOR_DATA_TOGGLE
    );
  ...
  _update(option) {
    ...
    const selected = this._elRoot.querySelector(
      CustomSelect.SELECTOR_OPTION_SELECTED
    );
    if (selected) {
  ...
  show() {
    document
      .querySelectorAll(CustomSelect.SELECTOR_ACTIVE)
      .forEach((select) => {
